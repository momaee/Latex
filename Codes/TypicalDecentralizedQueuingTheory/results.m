...
t_dist      = [0.8440       ,4.4696     ,10.1526    ,17.5418    ,23.7106    ,30.6480    ,37.5736    ,43.1921    ,48.4841    ,53.2560];
t_decent    = [0.7440       ,4.9696     ,9.1526     ,12.5418    ,16.1106    ,20.2480    ,25.2736    ,30.1921    ,35.4841    ,39.2560];
...
xlabel('Number of all nodes','FontSize',12)
ylabel('Optimization value(cost)','FontSize',12)
